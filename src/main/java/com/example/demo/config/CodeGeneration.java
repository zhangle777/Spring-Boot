...
public class CodeGeneration {
    ...
    private static String packageName="src/main/java";    //文件路径
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/byron");
...
//        strategy.setTablePrefix(new String[] { "sys_" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[] { "resource","role_resource" }); // 需要生成的表
